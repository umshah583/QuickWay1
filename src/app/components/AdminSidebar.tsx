...
import ModularAdminNav from "@/app/admin/ModularAdminNav";
  ...
  return (
    <aside className="fixed left-0 top-0 z-20 h-screen w-72 border-r border-slate-800 bg-slate-950 text-slate-200 shadow-2xl rounded-r-3xl">
      ...
      <div className="flex h-[calc(100vh-6rem)] flex-col justify-between pb-6 pt-4">
        {/* Navigation - Now uses modular system */}
        <nav className="px-3 overflow-y-auto">
          <ModularAdminNav notificationsCount={notificationsCount} bookingsNewCount={bookingsNewCount} />
        </nav>
        ...
        <div className="px-4">
          <div className="rounded-xl border border-slate-800 bg-slate-900 p-4">
            ...
            <p className="mt-1 text-xs text-slate-500">Modular Dashboard v2.0</p>
          </div>
        </div>
      </div>
    </aside>
